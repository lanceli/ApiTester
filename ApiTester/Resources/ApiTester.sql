...
INSERT INTO ZAPI (Z_PK,Z_ENT,Z_OPT,ZPROVIDER,ZNAME,ZHTTPMETHOD,ZBRIEFING,ZENDPOINTURL,ZDESCRIPTIONURL)
VALUES ("12","1","1","6","user/repos","GET","list user repositories","https://api.github.com/users/@user/repos","http://developer.github.com/v3/repos/");

-- Facebook
INSERT INTO ZAPI (Z_PK,Z_ENT,Z_OPT,ZPROVIDER,ZNAME,ZHTTPMETHOD,ZBRIEFING,ZENDPOINTURL,ZDESCRIPTIONURL)
VALUES ("13","1","1","5","connection/friends","GET","get friends of designated user","https://graph.facebook.com/@object/friends","http://developers.facebook.com/docs/reference/api/");
INSERT INTO ZAPI (Z_PK,Z_ENT,Z_OPT,ZPROVIDER,ZNAME,ZHTTPMETHOD,ZBRIEFING,ZENDPOINTURL,ZDESCRIPTIONURL)
VALUES ("14","1","1","5","connection/news","GET","get news of designated user","https://graph.facebook.com/@object/home","http://developers.facebook.com/docs/reference/api/");
INSERT INTO ZAPI (Z_PK,Z_ENT,Z_OPT,ZPROVIDER,ZNAME,ZHTTPMETHOD,ZBRIEFING,ZENDPOINTURL,ZDESCRIPTIONURL)
VALUES ("15","1","1","5","object/user","GET","get an user object","https://graph.facebook.com/@user","http://developers.facebook.com/docs/reference/api/");
...
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("38","2","1","0","12","@user","","1");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("39","2","0","1","12","type","public","1");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("40","2","0","1","12","page","1","0");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("41","2","0","1","12","per_page","30","0");

-- Facebook
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("42","2","0","0","13","@object","me","1");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("43","2","0","1","13","ids","","0");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("44","2","0","1","13","limit","10","0");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("45","2","0","0","14","@object","me","1");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("46","2","0","1","14","ids","","0");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("47","2","0","1","14","limit","10","0");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("48","2","0","0","15","@user","me","1");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("49","2","0","1","15","fields","","0");
INSERT INTO ZAPIPARAMETER (Z_PK,Z_ENT,Z_OPT,ZOPTIONAL,ZAPI,ZPARAMETERNAME,ZPARAMETERVALUE,ZCHECKED)
VALUES ("50","2","0","1","15","metadata","1","0");
